      ...
      <tbody>`;
            ...
            result.info.forEach(element => {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-outline-info" onclick="viewUser('${element.id}')">Ver</button>
                    </td>
                </tr>
                `
            });
...
function viewUser(idUser) {
    ...
    .then((response) => {
        ...
        if (response.status === 200) {
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="viewUserModalLabel">Ver Usuario</h1>
            ...
            document.getElementById('info').innerHTML = 
                '<div class="alert alert-danger">No se encontró el usuario en la API</div>'
        }
    })
    .catch(error => {
    ...
    const modalUser = `
        <div class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="createUserModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="createUserModalLabel">Crear Usuario</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card">
...
function saveUser() {
    ...
    if (form.checkValidity()) {
        ...
        .then((response) => {
            ...
            const modalId = document.getElementById('createUserModal')
